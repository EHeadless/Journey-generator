...
- Features should trace to the hierarchy: journey phase → demand space → circumstance → activation
- Reference the three experience types (marketing, product, service) when relevant
